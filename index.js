...
exports.loadPackage = async function (
  ...
  //Add an action button whenever the package gets loaded into the application
  let actionHtml = fs.readFileSync(
    path.resolve(__dirname, "sample_action.html"),
    { encoding: "utf-8" }
  );
  controller.sendMessageToRuntime({
    ...
    info: {
      actionId: -1,
      short: "xpackageactionstatic",
      name: "MouseMove",
      rendering: "standard",
      category: "package",
      desc: `Static Package Action`,
      blockTitle: "Static package action",
      defaultLua: "gmms(,)",
      color: "#9C92A4",
      icon: `
...
exports.unloadPackage = async function () {
  ...
  messagePorts.clear();
  //Remove every button added by the package when it gets undloaded
  while (buttonId > 0) {
    removeButton();
  }
  controller.sendMessageToRuntime({
...
async function addButton() {
  try {
    ...
    controller.sendMessageToRuntime({
      ...
      info: {
        actionId: buttonId++,
        short: "xpackageaction",
        name: "MouseMove",
        rendering: "standard",
        category: "package",
        desc: `Package ${buttonId}`,
        blockTitle: "Package action",
        defaultLua: "gmms(,)",
        color: "#9C92A4",
        icon: `
                <svg width="100%" height="100%" viewBox="-96 0 512 512"  xmlns="http://www.w3.org/2000/svg">
